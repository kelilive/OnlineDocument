...
- [Awesome .NET](#awesome-net)
  ...
  - [GUI](#gui)
    ...
    - [GUI - Themed Control Toolkits](#gui---themed-control-toolkits)
    - [GUI - other](#gui---other)
...
- [FreeSql](https:/github.com/dotnetcore/FreeSql) - a convenient ORM in dotnet, supports MySql, SqlServer, PostgreSQL, Oracle, Sqlite, Firebird, and Access. -  **NOTE**: This is not affiliated with Microsoft or .NET

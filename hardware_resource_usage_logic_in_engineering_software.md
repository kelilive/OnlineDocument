...
# What Mainstream Software Can Do at Different Hardware Levels

## BIM (Revit / Archicad / Tekla)

### Low‑end (can run)
- **CPU:** i5‑13400 / i5‑12400
- **GPU:** RTX 3050 / GTX 1660 Super
- **RAM:** 16GB
- Small residential models
- Basic modeling
- Simple families
- Small project documentation

### Mid‑range (mainstream engineers)
- **CPU:** i7‑13700K / i7‑14700K
- **GPU:** RTX A2000 / RTX 3060 / RTX 4060 Ti
- **RAM:** 32GB
...
### High‑end (large BIM projects)
- **CPU:** i9‑13900K / i9‑14900K
- **GPU:** RTX A4000 / RTX A4500 / RTX 4070 Ti
- **RAM:** 64GB
- Large hospitals, airports
- 1GB+ BIM models
- Heavy schedules
- Complex render views

## CAD (CATIA / SolidWorks / NX / AutoCAD)

### Low‑end
- **CPU:** i5‑13400 / i5‑12600K
- **GPU:** T1000 / RTX 3050
- **RAM:** 16GB
- Small part modeling
- Simple assemblies
...
### Mid‑range
- **CPU:** i7‑13700K / i7‑14700K
- **GPU:** RTX A2000 / RTX A4000 / RTX 4060 Ti
- **RAM:** 32GB
- Medium assemblies
- Surface modeling
- Heavy drawings
...
### High‑end
- **CPU:** i9‑13900K / i9‑14900K
- **GPU:** RTX A5000 / RTX A4500 / RTX 4080
- **RAM:** 64GB
- Large assemblies
- DMU
- Advanced surfacing
...
### High‑end
- **CPU:** Threadripper Pro 5975WX / Threadripper Pro 5995WX
- **GPU:** RTX A5000
- **RAM:** 128GB–256GB
- Million‑element models
- Nonlinear analysis
- Explicit dynamics
...
### Mid‑range
- **CPU:** i7‑13700K
- **GPU:** RTX 3060 / RTX 3070 / RTX 4060 Ti
- **RAM:** 32GB
- Medium scenes
- GPU rendering
